        ...
        <table className="w-full whitespace-nowrap overflow-x-auto">
          <thead>
            <tr className="h-16 w-full text-sm leading-none text-gray-800">
              ...
              <th className="font-bold text-left ">Leave Type</th>
              <th className="font-bold text-left ">From</th>
              <th className="font-bold text-left ">To</th>
              <th className="font-bold text-left ">No of Days</th>
              <th className="font-bold text-left ">Reason</th>
              <th className="font-bold text-left ">Status</th>
              <th className="font-bold text-left ">Actions</th>
            </tr>
          </thead>
