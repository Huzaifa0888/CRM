            ...
            <table className="w-full whitespace-nowrap overflow-x-auto">
              <thead>
                <tr className="h-16 w-full text-lg leading-none text-gray-800">
                  <th className="font-bold text-left ">Lead Name</th>
                  <th className="font-bold text-left px-2">Email</th>
                  <th className="font-bold text-left ">Phone</th>
                  <th className="font-bold text-left ">Country</th>
              ...
              <tbody className="w-full">
                <tr className="h-20 text-sm leading-none text-gray-800 bg-white hover:bg-gray-100 border-b border-t border-gray-400">
                  <td className=" cursor-pointer">
                    <p className="font-medium">Khizar Wakeel</p>
                  </td>
                  <td className="p-2">
                    <p className="font-medium">khizarwakeel@gmail.com</p>
                  </td>
                  <td className="p-2">
                    <p className="font-medium">03161314935</p>
                  </td>
                  <td className="p-2">
